    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_price', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
                ('member_price_per_class', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0)])),
                ('non_member_price', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
                ('non_member_price_per_class', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0)])),
                ('duration', models.IntegerField(choices=[(1, '1 Month'), (2, '2 Months'), (3, '3 Months')], default=1)),
