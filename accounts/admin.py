...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        (_('Important dates'), {'fields': ('date_joined', 'last_updated')}),
    )
    ...
    # Add groups and user permissions as horizontal filters
...
# Register the custom UserAdmin to handle our custom user model
admin.site.register(User, UserAdmin)
# admin.site.register(Group)  # Register the Group model if not already registered
